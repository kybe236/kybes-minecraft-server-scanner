...
// Helper: Convert an inclusive IPv4 range to minimal set of CIDRs
...
// Re-implement parse_ip_range for range parsing (returns Option<(Ipv4Addr, Ipv4Addr)>)
...
// Refactor load_blacklist to use only Vec<Ipv4Net>
